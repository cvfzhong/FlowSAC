...
public:
	...
	virtual int onEvent(int evt, int param1, int param2, void *data);
	...
	:public CVEventHandler
{
	...
	int _call(int event, int param1, int param2, void *data, _T*)
	{
		return eventOp(event, param1, param2, data);
	}
	int _call(int event, int param1, int param2, void *data, void*)
	{
...
public:
	...
	virtual void sendEvent(int evt, int param1, int param2, void *data) = 0;
