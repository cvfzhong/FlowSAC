...
int main(int argc, char *argv[])
{
	if (argc < 4)
	{
		printf("Example: flowsac2 ../data/sintel-train/list-all.txt flowfields sintel -method [flowsac|epicflow|ricflow] -o results.txt -L 3 -ucmT 0.1 -ransacT 2.6 -score SOD -fast -r 10\n");
		return 0;
	}
